      ...
      <div className="div">
            ...
            <div className="group">
              <div className="overlap-group">
                <img
                  className="vector"
                  alt="Vector"
                  src="https://c.animaapp.com/S3wv82L4/img/vector.svg"
                />
              </div>
              ...
              <div className="vector-wrapper">
                <img
                  className="vector"
                  alt="Vector"
                  src="https://c.animaapp.com/S3wv82L4/img/vector-1.svg"
                />
              </div>
            </div>
          </div>
        ...
        <div className="overlap-6">
          <img
            className="rectangle"
            alt="Rectangle"
            src="https://c.animaapp.com/S3wv82L4/img/rectangle-49.svg"
          />
